...
TRACKS = {
    'adelaide':          {'name': 'Adelaide Street Circuit',                      'downforce': 'very_high','style': 'stop_go', 'tire_stress': 'high',   'braking': 'heavy',   'bumpy': True},
    'aragon':            {'name': 'MotorLand Aragon',                             'downforce': 'medium',  'style': 'stop_go', 'tire_stress': 'medium', 'braking': 'heavy',   'bumpy': False},
    ...
    'miami':             {'name': 'Miami International Autodrome',                 'downforce': 'high',    'style': 'stop_go', 'tire_stress': 'high',   'braking': 'heavy',   'bumpy': False},
    'mid_ohio':          {'name': 'Mid-Ohio Sports Car Course',                    'downforce': 'medium',  'style': 'technical','tire_stress': 'medium','braking': 'medium',  'bumpy': False},
    'misano':            {'name': 'Misano World Circuit Marco Simoncelli',         'downforce': 'high',    'style': 'stop_go', 'tire_stress': 'medium', 'braking': 'heavy',   'bumpy': False},
    ...
    'portimao':          {'name': 'Algarve International Circuit',                  'downforce': 'medium',  'style': 'flowing', 'tire_stress': 'medium', 'braking': 'heavy',   'bumpy': True},
    ...
    'sachsenring':       {'name': 'Sachsenring',                                   'downforce': 'high',    'style': 'technical','tire_stress': 'high',   'braking': 'medium',  'bumpy': False},
    ...
    'st_pete':           {'name': 'St. Petersburg Grand Prix',                     'downforce': 'very_high','style': 'stop_go', 'tire_stress': 'high',   'braking': 'heavy',   'bumpy': True},
    'summit_point':      {'name': 'Summit Point Raceway',                          'downforce': 'medium',  'style': 'technical','tire_stress': 'medium','braking': 'medium',  'bumpy': False},
    ...
    'the_bend':          {'name': 'The Bend Motorsport Park',                      'downforce': 'medium',  'style': 'flowing', 'tire_stress': 'medium', 'braking': 'medium',  'bumpy': False},
